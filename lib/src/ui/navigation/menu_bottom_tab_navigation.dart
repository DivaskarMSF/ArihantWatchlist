...
import '../../../changes/screens/watch_screen.dart';
...
class MenuBottomTabNavigationState
  ...
  List<Widget> _getTabDetails() {
    List<Widget> listdata = <Widget>[
      ...
      TradesScreen(arguments: {'selectedIndex': selectedTradesIndex,'toGtd': widget.arguments?["toGtd"] ?? false },
      ),
  ...
  List<Map<String, dynamic>> _getMenuItems() {
    final List<Map<String, dynamic>> menuList = <Map<String, dynamic>>[
      ...
      // new changes
        ...
        AppConstants.title: _appLocalizations.watch
      },
    ];
